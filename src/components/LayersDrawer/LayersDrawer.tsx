...
export default function LayersDrawer({ layerOn, setLayerOn }: LayersDrawerProps) {
    ...
    <div className={styles['LayersDrawer-root']}>
      ...
      >
        ...
        <Card sx={{ padding: '8px', backgroundColor: 'gray' }}>
          <h3>Sediment</h3>
          <Typography sx={{ display: 'inline-block' }}>Toggle PMTiles layer</Typography>
          <Switch sx={{ display: 'inline-block' }} checked={layerOn} onChange={toggleLayer} />
        </Card>
        {/* End temp code */}
      </StyledSwipeableDrawer>
    </div>
